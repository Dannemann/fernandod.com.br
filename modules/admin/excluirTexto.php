...
<head>
	<title>Excluir texto (FKDADM)</title>
...
if ($_GET['delete'] == "ok") {
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<span style=\"color:red;font-size:14px;font-weight:bold\">Texto excluido com sucesso!</span>";
}
...
<table style="font-size:12px;font-family:Verdana, Geneva, sans-serif">
	<tr>
		<td>
			<br /><font color="red" style="font-weight: bold;">EXCLUIR:</font><br /><br /><br /><br />
...
<?php
	...
	if (isset($_POST["categ"]) && $_POST["categ"] != '') {
		...
		while ($rowTextoPorCategoria = mysql_fetch_row($queryTextosPorCategoria)) {
			...
			$resultadoFinalDaBusca = $resultadoFinalDaBusca."<a href=\"excluirTextoAction.php?texto=".$rowTextoPorCategoria[4]."\">";
			$resultadoFinalDaBusca = $resultadoFinalDaBusca."<img width=\"16\" height=\"16\" src=\"../../images/admin/delete_icon.png\" /> - ";
			$resultadoFinalDaBusca = $resultadoFinalDaBusca."</a>";
...
<a href="excluirTextoAction.php?texto=<?=$rowBusca[4]?>">
<img width="16" height="16" src="../../images/admin/delete_icon.png" /> -
</a>
<span>
